...
do
    ...
    mask_path=$DATASET_PATH/semantic/masks/${num_chosen}_mask.png
...
colmap stereo_fusion   --output_path ${ws}/dense/mask_erode0pixel/mask.ply --workspace_path ${ws}/dense/mask_erode0pixel --StereoFusion.mask_path  $DATASET_PATH/semantic/org_binary_mask/
python $vis_point_cloud_py_path --input_cloud  ${ws}/dense/mask_erode0pixel/mask.ply --output_cloud  ${ws}/dense/mask_erode0pixel/mask_clean_std1.ply --std_ratio 1
